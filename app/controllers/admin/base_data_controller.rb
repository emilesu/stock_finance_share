class Admin::BaseDataController < AdminController
  ...
  def update_stock_finance_table
    ...
    # @stocks.each do |s|
      ...
      # zcb 资产表更新
      response_zcb = RestClient.get "http://future.liangyee.com/bus-api/corporateFinance/MainStockFinance/getBalanceSheet", :params => { :userKey => KEY_CONFIG["liangyee_api_key"], :symbol => 600000, :yearly => true }
