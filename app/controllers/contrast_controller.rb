class ContrastController < ApplicationController
  ...
  def index
    ...
    if a.present? && a.split(" - ")[-1] == "US"
      ...
      @stock_a_static_data = @stock_a.static_data
      ...
      @stock_a_static_data = @stock_a.static_data_5
    ...
    if b.present? && b.split(" - ")[-1] == "US"
      ...
      @stock_b_static_data = @stock_a.static_data
      ...
      @stock_b_static_data = @stock_a.static_data_5
    ...
    if !c.blank?
      if c.present? && c.split(" - ")[-1] == "US"
        ...
        @stock_c_static_data = @stock_a.static_data
        ...
        @stock_c_static_data = @stock_a.static_data_5
